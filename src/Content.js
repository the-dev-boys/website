            ...
            {photos.map((photo, i) => {
                return (
                    <div className='w-auto place-self-center' key={i}>
                        <Picture url={photo.url} label={photo.label} />
                    </div>
                )
            })}
        </main>
